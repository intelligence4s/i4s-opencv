...
/**
 * NOTE: Copied from Scala 2.13 standard library for utilization for 2.12. It's a good tool for representing operations that
 * must clean up resources on exit and is compatible with Scala 2.12 sematics.
 */
object Using {
